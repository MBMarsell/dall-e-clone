...
const CreatePost = () => {
    ...
    if (form.prompt) {
      try {
        ...
        const response = await fetch(
          'https://dall-e-uzbq.onrender.com/api/v1/dalle',
          {
            method: 'POST',
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        const response = await fetch(
          'https://dall-e-uzbq.onrender.com/api/v1/post',
          {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          ...
          <button
            type="submit"
            className="mt-3 text-white bg-[#df6420] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
